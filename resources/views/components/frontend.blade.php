...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__cart">
            <ul>
                <li>
                    <a href="#"><i class="fa fa-shopping-bag"></i> <span class="shoppingcartNoti"></span>
                    </a>
                </li>
            </ul>
            <a href="">
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li><a href="./shop-grid.html"> Promotion </a></li>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="{{route('index')}}"><img src="logo/logo_transparent.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            <li>
                                <a href="{{route('shoppingcart')}}"><i class="fa fa-shopping-bag"></i> <span class="shoppingcartNoti"></span></a>
                            </li>
                        </ul>
                        <a href="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__about__logo">
                            <a href="{{route('index')}}"><img src="frontend/img/logo.png" alt=""></a>
                        </div>
                        <ul>
