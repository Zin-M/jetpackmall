                        ...
                        <div class="tile-body">
                            <form action="{{route('backside.category.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" id="name_id" name="name"><div class="text-danger form-control-feedback">{{$errors->first('name')}}</div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      ...
                                      <div class="text-danger form-control-feedback">{{$errors->first('photo')}}</div>
                                    </div>
                                </div>
