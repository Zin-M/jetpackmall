                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{route('backside.category.destroy',$id)}}" method="POST" class="d-line-block" onsubmit="return confirm('Are you sure want to delete?')"> 
                                                    @csrf
                                                    @method('DELETE')
                                                    <button class="btn btn-outline-danger" type="sumbit"> <i class="icofont-close icofont-1x"></i></button>
                                                </form>
